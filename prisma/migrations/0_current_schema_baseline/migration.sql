...
-- CreateEnum
CREATE TYPE "FreshPreorderStage" AS ENUM ('PENDING_STORE_CONFIRMATION', 'CONFIRMED_WAITING_PICKUP', 'COMPLETED_OFFLINE_SETTLED', 'CANCELLED');
...
-- CreateTable
CREATE TABLE "FreshPreorderDetail" (
    "id" TEXT NOT NULL,
    "orderId" TEXT NOT NULL,
    "stage" "FreshPreorderStage" NOT NULL DEFAULT 'PENDING_STORE_CONFIRMATION',
    "estimatedTotalCents" INTEGER,
    "actualWeightJin" DECIMAL(10,2),
    "actualUnitPriceCents" INTEGER,
    "finalTotalCents" INTEGER,
    "storeConfirmNote" TEXT,
    "customerContactNote" TEXT,
    "cancelReason" TEXT,
    ...
    CONSTRAINT "FreshPreorderDetail_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "OrderNote_authorAdminId_idx" ON "OrderNote"("authorAdminId");
...
-- CreateIndex
CREATE UNIQUE INDEX "FreshPreorderDetail_orderId_key" ON "FreshPreorderDetail"("orderId");

-- CreateIndex
CREATE INDEX "FreshPreorderDetail_stage_idx" ON "FreshPreorderDetail"("stage");

-- CreateIndex
CREATE INDEX "FreshPreorderDetail_orderId_idx" ON "FreshPreorderDetail"("orderId");
...
-- AddForeignKey
ALTER TABLE "OrderNote" ADD CONSTRAINT "OrderNote_authorAdminId_fkey" FOREIGN KEY ("authorAdminId") REFERENCES "AdminUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "FreshPreorderDetail" ADD CONSTRAINT "FreshPreorderDetail_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
